...
books_path = Path('data/books_reduced.csv')
if books_path.is_file():
    books_df = pd.read_csv('data/books_reduced.csv')
else:
    books_a_df = pd.read_csv('data/books_a.csv')
    books_b_df = pd.read_csv('data/books_b.csv')
    books_c_df = pd.read_csv('data/books_c.csv')
    books_d_df = pd.read_csv('data/books_d.csv')
    books_e_df = pd.read_csv('data/books_e.csv')
    books_f_df = pd.read_csv('data/books_f.csv')

    books_df = pd.concat([books_a_df, books_b_df, books_c_df, books_d_df, books_e_df, books_f_df], ignore_index=True)
    # books_df.to_csv('data/books_reduced.csv', index=False)
